...
int main(void)
{
  ...
  status = xTaskCreate(task3_handler, "Task-3", configMINIMAL_STACK_SIZE, "Hello world from Task-3", 2, &task3_handle);
  configASSERT(status == pdPASS);
...
static void task1_handler(void *parameters)
{
  ...
  while (1)
  {
    ...
    // Delay until 1000 ms (1 second) from the lastWakeTime
...
static void task2_handler(void *parameters)
{
  ...
  while (1)
  {
    ...
    // Delay until 800 ms (0.8 seconds) from the lastWakeTime
...
static void task3_handler(void *parameters)
{
  ...
  while (1)
  {
    ...
    // Delay until 400 ms (0.4 seconds) from the lastWakeTime
